...
#+begin_src latex :tangle fig-Efficiency-Equity_1047-02.tex
\begin{tikzpicture}<<upf-scale>>
...
#+begin_src latex :tangle fig-Efficiency-Equity_1047-05.tex
\begin{tikzpicture}<<upf-scale>>
...
#+begin_src latex :tangle fig-Efficiency-Equity_1047-06.tex
\begin{tikzpicture}<<upf-scale>>
