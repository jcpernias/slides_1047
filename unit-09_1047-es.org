...
- Tres alternativas: Parque, piscina y biblioteca.
...
2. *Decisión no dictatorial*: las preferencias sociales no deben
   reflejar simplemente las preferencias de un único individuo y deben
...
5. *Dominio no restringido*: Debe de producir una ordenación sean
   cuales sean las alternativas y las preferencias de los individuos.
...
- El *Teorema de imposibilidad de Arrow* establece que si existen al
  ...
  ninguna regla de elección colectiva que cumpla las 4 condiciones
  ideales.
...
#+MATS: figcol fig-09_1047-unimodal-1-*.pdf 0.5

Las preferencias de todos los individuos son unimodales.


** Preferencias bimodales

#+MATS: figcol fig-09_1047-unimodal-2-*.pdf 0.5

Las preferencias de C son bimodales.
