...
#+begin_src latex :tangle fig-Public-Goods_1047-01.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-02.tex
\begin{tikzpicture}<<bc-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-03.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-04.tex
\begin{tikzpicture}<<bp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-05.tex
\begin{tikzpicture}<<bp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-06.tex
\begin{tikzpicture}<<bp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-11.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-13.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-14.tex
\begin{tikzpicture}<<mp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-15.tex
\begin{tikzpicture}<<mp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-16.tex
\begin{tikzpicture}<<mp-scale>>
...
#+begin_src latex :tangle fig-Public-Goods_1047-20.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-21.tex
  \begin{tikzpicture}[xscale=0.36, yscale=0.36]
...
#+begin_src latex :tangle fig-Public-Goods_1047-30.tex
...
#+begin_src latex :tangle fig-Public-Goods_1047-31.tex
  \begin{tikzpicture}[xscale=0.4, yscale=0.4, samples = 128]
...
#+begin_src latex :tangle fig-Public-Goods_1047-32.tex
  \begin{tikzpicture}[xscale=0.4, yscale=0.4, samples = 128]
...
#+begin_src latex :tangle fig-Public-Goods_1047-33.tex
  \begin{tikzpicture}[xscale=0.4, yscale=0.4, samples = 128]
