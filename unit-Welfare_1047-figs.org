...
#+begin_src latex :tangle fig-Welfare_1047-01.tex
...
#+begin_src latex :tangle fig-Welfare_1047-02.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-03.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-04.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-05.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-06.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-07.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-08.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-09.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-09b.tex
\begin{tikzpicture}<<output-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-10.tex
...
#+begin_src latex :tangle fig-Welfare_1047-10b.tex
\begin{tikzpicture}<<upf-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-11.tex
...
#+begin_src latex :tangle fig-Welfare_1047-12.tex
\begin{tikzpicture}[xscale=0.04545, yscale=0.04545, samples=128]
...
#+begin_src latex :tangle fig-Welfare_1047-13.tex
\begin{tikzpicture}[xscale=0.04545, yscale=0.04545, samples=128]
...
#+begin_src latex :tangle fig-Welfare_1047-22.tex
...
#+begin_src latex :tangle fig-Welfare_1047-23.tex
\begin{tikzpicture}<<input-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-24.tex
\begin{tikzpicture}<<input-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-25.tex
\begin{tikzpicture}<<input-box-scale>>
  \newcommand*{\Mx}{80}
  \newcommand*{\My}{20}
...
#+begin_src latex :tangle fig-Welfare_1047-28.tex
\begin{tikzpicture}<<input-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-29.tex
\begin{tikzpicture}<<input-box-scale>>
  \newcommand*{\Mx}{80}
  \newcommand*{\My}{20}
...
#+begin_src latex :tangle fig-Welfare_1047-29b.tex
\begin{tikzpicture}<<input-box-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-30.tex
...
#+begin_src latex :tangle fig-Welfare_1047-30b.tex
\begin{tikzpicture}<<ppf-scale>>
...
#+begin_src latex :tangle fig-Welfare_1047-31.tex
\begin{tikzpicture}<<ppf-scale>>
