...
#+begin_src latex :tangle fig-06_1047-20.tex
  \begin{tikzpicture}[xscale=0.36, yscale=0.36]
    ...
    \draw[curve, colorD] (0, 3) -- (9.5, 3) node[right] { $c$ }
      (9.5, 3) node[right] { \phantom{$c + c_{t}$} };
...
#+begin_src latex :tangle fig-06_1047-21.tex
  \begin{tikzpicture}[xscale=0.36, yscale=0.36]
    ...
    \draw[help lines]
       (4.5, 4.5) -- (4.5, 0) node[below] {$Q_m$}
       (6, 3) -- (6, 0) node[below] {$Q^*$}
       (9, 3) --
       (9, 0) node[below] {$Q_p$} ;
    ...
    \draw[curve, colorD] (0, 4.5) -- (9.5, 4.5) node[right] { $c + c_t$ };
