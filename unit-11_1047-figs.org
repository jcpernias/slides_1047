...
#+begin_src latex  :noweb-ref draw-curve-av-D0
  ...
  ($ (D0-1)!0.85!(D0-2) $) node[right, yshift = 0pt] { $D_0$ } ;
#+end_src
...
#+begin_src latex  :noweb-ref monop-draw-curve-CM
  \draw[curve B, use path=\pathCM] (CM-2) node[right] { $\CMg$ } ;
#+end_src
...
#+begin_src latex  :noweb-ref monop-draw-curve-CMt
  \draw[curve B, use path=\pathCMt] (CMt-2) node[right] { $\CMg + t$ } ;
#+end_src
...
#+begin_src latex  :noweb-ref monop-draw-curve-IM
  \draw[curve A, use path=\pathIM] ($ (IM-1)!0.9!(IM-2) $) node[right] { $\IMg$ } ;
#+end_src
...
#+begin_src latex  :noweb-ref av-monop-draw-curve-D0
  \draw[curve A, use path=\pathDzero]
  ($ (D0-1)!0.95!(D0-2) $)
  node[right, yshift = 0.75pt, font=\footnotesize] { $D_0$ }
  ;
#+end_src
...
#+begin_src latex  :noweb-ref av-monop-draw-curve-IM0
  \draw[curve C, use path=\pathIMzero]
  ($ (IM0-1)!0.94!(IM0-2) $)
  node[right, xshift = -2.5pt, font=\footnotesize] { $\IMg_0$ }
  ;
#+end_src
...
#+begin_src latex  :noweb-ref av-monop-draw-curve-D1
  ...
  ($ (D1-1)!0.71!(D1-2) $)
  node[below, yshift = 3.5pt, font=\footnotesize] { $D_1$ }
  ;
#+end_src
...
#+begin_src latex  :noweb-ref av-monop-draw-curve-IM1
  \draw[curve C, use path=\pathIMone]
  ($ (IM1-1)!0.83!(IM1-2) $)
  node[left, xshift=-5.5pt, fill=white, inner sep = 0pt, font=\footnotesize] { $\IMg_1$ }
  ;
#+end_src
