...
** COMMENT Evaluación de proyectos
...
1. Identificación de los proyectos alternativos.

2. Enumeración para cada alternativa de los factores y recursos que se
   utilizarán y de la producción que se obtendrá.

3. Valoración monetaria de los factores y de la producción.
...
- Los precios de mercado no existen o, a causa de un fallo de mercado,
  no representan el coste de oportunidad social.


** Excedente de los consumidores

- La valoración del proyecto debe incluir las variaciones del
  bienestar de todas las partes implicadas.

- La evaluación pública de un proyecto debe tener en cuenta tanto
  ingresos monetarios como el excedente de los consumidores.


** El valor del tiempo

- Mejoras en el transporte pueden ahorrar tiempo a los usuarios.

- Frecuentemente se usa el salario neto de impuestos como una medida
  del valor del tiempo para un trabajador.
...
- Si estaban desempleados su coste de oportunidad es el valor del
  ocio, generalmente inferior al salario de mercado.
...
- no hay fallos de mercado; y

- los beneficiarios del proyecto son los mismos que soportan los
  costes.
...
- Se usa cuando es difícil estimar los beneficios, los cuales se
  consideran equivalentes entre las diferentes alternativas.


** COMMENT Errores comunes
