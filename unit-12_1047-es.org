...
- Si un impuesto es *neutral* los contribuyentes no pueden hacer nada
  para alterar su carga tributaria. El único efecto de los impuestos
  de *tanto alzado* (/lump-sum taxes/) es el efecto renta.
...
** COMMENT La elección individual

#+MATS: figcol file:fig-12_1047-01-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-02-*.pdf 0.47

- Sin impuesto, la elección óptima del consumidor es la cesta $E_0$.

- Después introducir un impuesto sobre las compras de bien $X$ la  cesta óptima es $E_1$.


** Recaudación

#+MATS: figcol file:fig-12_1047-03-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-04-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-05-*.pdf 0.47

- La variación equivalente, en unidades de $Y$, es igual a $Y'_1 -
  Y''_1$.

- Si se estableciera un impuesto de suma fija igual a $Y'_1 -
  Y''_1$, el consumidor elegiría $E_2$.


** Exceso de gravamen

#+MATS: figcol file:fig-12_1047-06-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-07-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-10-*.pdf 0.47
...
#+MATS: figcol file:fig-12_1047-11-*.pdf 0.47
...
** COMMENT Cálculo del exceso de gravamen
...
#+MATS: figcol file:fig-12_1047-20-*.pdf 0.47
